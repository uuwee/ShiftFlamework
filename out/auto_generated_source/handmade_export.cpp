...
EXPORT ExportObject*
ShiftFlamework_Entity_get_component_ShiftFlamework_ScreenSpaceMesh(
    ExportObject* self) {
  auto component = std::static_pointer_cast<Entity>(self->object)
                       ->get_component<ScreenSpaceMesh>();
...
EXPORT ExportObject*
ShiftFlamework_Entity_add_component_ShiftFlamework_ScreenSpaceMesh(
    ExportObject* self) {
  auto component = std::static_pointer_cast<Entity>(self->object)
                       ->add_component<ScreenSpaceMesh>();
  auto container = new ExportObject(component);
  return container;
}
...
ShiftFlamework_Entity_add_component_ShiftFlamework_ScreenSpaceTransform(
    ExportObject* self) {
  auto comopnent = std::static_pointer_cast<Entity>(self->object)
                       ->add_component<ScreenSpaceTransform>();
...
EXPORT ExportObject* ShiftFlamework_Entity_add_component_ShiftFlamework_Script(
    ExportObject* self) {
  auto component =
      std::static_pointer_cast<Entity>(self->object)->add_component<Script>();
  auto container = new ExportObject(component);
  return container;
}
...
EXPORT ExportObject* ShiftFlamework_Entity_get_component_ShiftFlamework_Script(
    ExportObject* self) {
  auto component =
      std::static_pointer_cast<Entity>(self->object)->get_component<Script>();
  auto container = new ExportObject(component);
  return container;
}
