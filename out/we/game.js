...
// end include: preamble.js
  ...
  function _wgpuAdapterReference(id) { WebGPU.mgrAdapter.reference(id) }
  ...
  function _wgpuDeviceGetLimits(deviceId, limitsOutPtr) {
  ...
  function _wgpuInstanceReference() {
      // no-op
    }
  ...
  function _wgpuPipelineLayoutReference(id) { WebGPU.mgrPipelineLayout.reference(id) }
  ...
  function _wgpuSwapChainReference(id) { WebGPU.mgrSwapChain.reference(id) }
